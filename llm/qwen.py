...
class QwenInfer:
    ...
    def load_models_tokenizer(self, model_path):
        ...
        model.generation_config.repetition_penalty = 0.92 # disable repetition penalty #92 best
    ...
    def call_api(self, prompt):
        ...
        output = self.model.generate(**inputs, max_new_tokens= 1000 ,temperature = 0.7) 
